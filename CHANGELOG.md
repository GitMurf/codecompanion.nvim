...
## [12.0.0](https://github.com/GitMurf/codecompanion.nvim/compare/v13.2.1...v12.0.0) (2025-03-06)
...
* **adapters:** add Hugging Face adapter ([#527](https://github.com/GitMurf/codecompanion.nvim/issues/527)) ([48747c4](https://github.com/GitMurf/codecompanion.nvim/commit/48747c4e36eb0a3f44d6d9e55f8089b9e27cacfc))
...
* **chat:** :sparkles: `blink.cmp` support ([cb2c93f](https://github.com/GitMurf/codecompanion.nvim/commit/cb2c93f8a6b0ab0522a814f244b8011a7275ea3b))
* **chat:** :sparkles: can pin buffers and files to requests ([fc8ee3a](https://github.com/GitMurf/codecompanion.nvim/commit/fc8ee3a085a44d0ef0111be0499f6552d7dbe865))
...
* **chat:** add `CodeCompanionChatOpened` event ([fdfc640](https://github.com/GitMurf/codecompanion.nvim/commit/fdfc640f638de7e44580c75882b81cc6dd99b950))
* **chat:** adding to chat initializes buffer if needed ([#567](https://github.com/GitMurf/codecompanion.nvim/issues/567)) ([8c82ced](https://github.com/GitMurf/codecompanion.nvim/commit/8c82cedc3d70255ec6ea0fdb348b3e931c435fba))
* **chat:** can delete references ([367eccc](https://github.com/GitMurf/codecompanion.nvim/commit/367eccc7cc57edcc249bae850ac4ccdf599a060c))
* **chat:** can delete references ([c0b8c25](https://github.com/GitMurf/codecompanion.nvim/commit/c0b8c2522c20b8369201132a4ce953f3cdf7b5e2))
* **chat:** customize split position ([#556](https://github.com/GitMurf/codecompanion.nvim/issues/556)) ([7374192](https://github.com/GitMurf/codecompanion.nvim/commit/73741920097f36c762bb8fe1f4de6617389e2d4c))
...
* **slash_commands:** `help` cmd now prompts user to trim if exceeding max_lines ([33c326a](https://github.com/GitMurf/codecompanion.nvim/commit/33c326a0d31473ecf3112d783dbcc22afccfb801))
...
* [#542](https://github.com/GitMurf/codecompanion.nvim/issues/542) use vim.treesitter instead of nvim-treesitter. ([#543](https://github.com/GitMurf/codecompanion.nvim/issues/543)) ([b741490](https://github.com/GitMurf/codecompanion.nvim/commit/b741490066c0129554300e493f27767b760ffa16))
...
* **adapters:** [#528](https://github.com/GitMurf/codecompanion.nvim/issues/528) Gemini adapter fails if system prompt is removed ([7ca4364](https://github.com/GitMurf/codecompanion.nvim/commit/7ca43642376d7768a3f2ecea2cd99ae9a792451a))
* **adapters:** [#560](https://github.com/GitMurf/codecompanion.nvim/issues/560) nil url in openai_compatible adpater ([5cc2693](https://github.com/GitMurf/codecompanion.nvim/commit/5cc26934b0732dda03d311195e6d3f357e4f4a0c))
...
* **adapters:** further openai_compatible fixes ([a84f6ff](https://github.com/GitMurf/codecompanion.nvim/commit/a84f6ff4be745bcff7d69af96fdbdae2465a33a2))
* **adapters:** gemini-2.0-flash-exp inline strategy ([#568](https://github.com/GitMurf/codecompanion.nvim/issues/568)) ([a9faa69](https://github.com/GitMurf/codecompanion.nvim/commit/a9faa69d3bf8308b78deab97292af2acc57d2f87))
...
* **adapters:** openai_compatible ([0d1388f](https://github.com/GitMurf/codecompanion.nvim/commit/0d1388f7409f06e96ef2a7eadfa76c1dcfb74648))
...
* **chat:** show documentation for blink.cmp ([f41dbab](https://github.com/GitMurf/codecompanion.nvim/commit/f41dbab850572b290e37e0b52244b8ccb9699870))
...
* **cmd:** strategy now respects `vim.g.codecompanion_adapter` ([b629005](https://github.com/GitMurf/codecompanion.nvim/commit/b629005f0467471b4439192492cea2d49f22d52f))
...
* **inline:** [#531](https://github.com/GitMurf/codecompanion.nvim/issues/531) inline edits in c++ buffers ([73e8ea5](https://github.com/GitMurf/codecompanion.nvim/commit/73e8ea561e81cce3b9c75d825b8294e0a82fc4e9))
...
* **slash_commands:** [#515](https://github.com/GitMurf/codecompanion.nvim/issues/515) help tags line limit can be customised ([e1b9876](https://github.com/GitMurf/codecompanion.nvim/commit/e1b9876641e4ea0fa80f78339c260b16b729a21f))
...
* **slash_commands:** prompt library now works with blink.cmp ([1027f47](https://github.com/GitMurf/codecompanion.nvim/commit/1027f47c6c583a6b6592ae60a8008d780517792a))
...
* **workflow:** can auto_submit the first prompt ([86f96d5](https://github.com/GitMurf/codecompanion.nvim/commit/86f96d5419915b0711afbc93d948a3312bfc25b6))
* **workflows:** wrap in `vim.schedule` for performance ([f0f6e26](https://github.com/GitMurf/codecompanion.nvim/commit/f0f6e260a98c5ffe6ff6257227d1f429a4ecb07c))
...
* **agents:** agents are now in `strategies.chat.agents` ([3f437a6](https://github.com/GitMurf/codecompanion.nvim/commit/3f437a62d55ad6efe14a4af2ffdc4e474696852a))
